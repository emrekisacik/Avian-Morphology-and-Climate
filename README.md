...
The observed relationship between overall body size and climate is statistically significant, but notably weaker than expected. This is likely due to the global scale of the analysis. Most existing literature focuses on specific regions or species, where selective pressures are more uniform. Including all bird species worldwide can introduce ecological noise and mask general trends. Another limitation can be that the bird dataset provides summary statistics rather than individual measurements. Using a mean of measurements ignores the variation among individuals of the species, and does not account for the local climates the individuals live in. As a result, the resolution of data can be too low to observe more significant trends regarding climate. One more limitation is the fact that the species are not completely independent data points due to shared evolutionary history. That is, despite living in different climates, two species can have similar morphologies due to relatedness. This phylogenetic signal can also create bias in the data.

Among the selected traits, tarsus length shows the strongest correlation with temperature. This suggests that tarsus length is either more sensitive to temperature or, probably, a more reliable measure of overall body size. It is important to consider that mass can highly vary in birds based on sex, season, or recent feeding. since birds are relatively light animals, these changes can create significant noise. On the other hand, the leg size remain the same in adults. For this reason, there are studies that prefer tarsus length over mass to infer overall body size to conduct similar correlation analyses. 

The revealed relationship between overall body size climate is statistically significant but considerably weaker than expected. This might be due to the fact that the analysis is done on all the bird species worldwide, while the analyses on the literature regarding this topic is mostly done on an identified region or species. Such relationships could be more visible when limited to certain region or species, which would eliminate the noise from all the species worldwide. Another reason might be that each species is represented by a summary statistics, instead of actual individual measurements, which limits the resolution in terms of both morphological measurements but also geographical location of the individual. 

Despite the weak correlations, the negative relationship between body size and minimum temperature is consistent with Bergmann’s Rule. The data suggests that larger bodies are an adaptation for cold resistance, as a lower surface area to volume ratio helps reduce heat loss. The finding that these correlations are most significant with minimum temperature supports the idea that cold extremes apply a primary selective pressure on body size. In warmer climates, it is likely that other evolutionary constraints come into play and mask the effect of temperature.

The negative correlation between body mass and precipitation suggests that larger bodies are better adapted to drier climates, where water and food are often scarce. This adaptation likely helps reduce evaporative water loss through a lower surface area to volume ratio. Additionally, a larger body mass allows for greater fat storage, providing an energy reserve in food-poor environments.

Although the correlation is weak, the positive relationship between beak length and temperature aligns with Allen’s Rule. The data suggests that shorter beaks help retain internal heat in the cold, while longer beaks act as radiators for heat dissipation in warm climates.

### **4.2. Ecological Factors**

Random forest regression is used where hypothesis testing falls short. The regression model helps to identify non-linear relationships while handling the high variety of the ecological variables by ranking their relative importance. As a result, trophic niche and primary lifestyle are the strongest drivers of morphology, while climatic factors are less impactful. This suggests that climate is a weak selective force when compared to ecological factors. This might be due to the fact that these factors are often episodic while the ecological niche is constant. For example, the birds have to eat or move everyday to survive but they are exposed to challenging temperature or precipitation events only during certain times of the year. In addition, the ecological factors are discrete unlike the climatic factors that form a gradient. This suggests that, for instance, being a predator or not can result in a more significant difference than the temperature being 20 versus 30 °C. 

PCA is essential for this project to better test the overall morphology rather than individual traits. Since the morphological traits often correlate, analyzing the traits individually can be redundant. For example, the birds with a larger body mass often have longer appendages anyway, thus testing each trait by itself is not as informative as wanted. Instead, using PCA, these traits are reduced into two principal components that represent the overall body size, taking each trait into account to an ideal extent. This way, it is possible to conclude on the overall morphology based on the variables tested. As a result, consistent with the hypothesis testing and the regression model, ecology is a strong selective force on morphology, specifically trophic niche and primary lifestyle. Additionally, it is possible to conclude how migration and habitat drive morphology by visualizing the clusters.

An important finding is that birds in aquatic habitats, and thus with an aquatic lifestyle, often show a larger body size. This can be due to the difference in physical properties of air and water. On water, buoyancy supports the bird's weight against gravitation, allowing the species to afford a larger body mass. 

As for migration, wing shape shows a distinct pattern while overall body size is not significantly affected. The observation that migratory birds have more pointed wings makes sense from an aerodynamics perspective. Pointed wings help reduce induced drag, ideal for long flights on higher altitudes. On the other hand, sedentary birds tend to have round wings that provide better maneuverability for quick movements through obstacles on land, such as avoiding predators or flying between trees. This pattern overlaps with the finding that birds in closed habitats tend to be smaller. This can be an adaptation to hide from predators, or again, to fly through dense vegetation. To compare, being smaller in open habitats such as deserts is not as advantageous. Due to weak vegetation, there is little cover to hide and also fewer obstacles to fly through, which favors faster flight rather than smaller body. 

Similarly, aerial birds are found to have significantly lighter bodies, likely to be able to fly constantly against the pull of gravity. This overlaps with the finding about birds feeding on nectars, fruits, or seeds. Since these species often fly, hover, or hang on thin branches while they are eating, their body has to be light. 

## **5. Conclusion**

In conclusion, avian morphology shows significant relationships with climate, especially lower temperature limits, which aligns with the ecological rules and expectations. However, ecological factors, most importantly trophic niche and primary lifestyle, influence the morphology to a greater extent. Overall, the project demonstrates how body size and dimensions are shaped by climatic limitations as well as ecological considerations in birds, highlighting its importance of both factors for survival.